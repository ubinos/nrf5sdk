if(INCLUDE__NRF5SDK)
    ...
    if(NRF5SDK__CRYPTO_ENABLED)
        ...
        if(NRF5SDK__CRYPTO_MBEDTLS_ENABLED)
	        ...
	        include_directories(${_tmp_source_dir}/nRF5_SDK/external/nrf_tls) 

			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/aes.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/aesni.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/arc4.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/asn1parse.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/base64.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/bignum.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/blowfish.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/camellia.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ccm.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/certs.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/cipher.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/cipher_wrap.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/cmac.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ctr_drbg.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/debug.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/des.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/dhm.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ecdh.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ecdsa.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ecp.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ecp_curves.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/entropy.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/entropy_poll.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/error.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/gcm.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/havege.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/hmac_drbg.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/md.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/md2.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/md4.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/md5.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/md_wrap.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/memory_buffer_alloc.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/oid.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/padlock.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pem.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pk.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pk_wrap.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pkcs11.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pkcs12.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pkcs5.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pkparse.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/pkwrite.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/platform.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ripemd160.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/rsa.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/sha1.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/sha256.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/sha512.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ssl_cache.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ssl_ciphersuites.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ssl_cli.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ssl_cookie.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ssl_ticket.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/ssl_tls.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/threading.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/version.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/version_features.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/x509.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/x509_create.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/x509_crl.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/x509_crt.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/x509_csr.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/mbedtls/library/xtea.c)
			
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/nrf_tls/mbedtls/replacements/asn1write.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/nrf_tls/mbedtls/replacements/ssl_srv.c)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/nrf_tls/mbedtls/tls_interface.c)
    ...
    if(NRF5SDK__MQTT_ENABLED)
        ...
        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt)
    
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt.c)
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt_decoder.c)
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt_encoder.c)
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt_rx.c)
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt_transport.c)
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt_transport_lwip.c)
        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/mqtt/mqtt_transport_tls.c)
