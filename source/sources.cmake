if(INCLUDE__NRF5SDK)
    ...
    if(NRF5SDK__USBD_ENABLED)
	    ...
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/app_usbd.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/app_usbd_core.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/app_usbd_serial_num.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/app_usbd_string_desc.c)
	    
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/audio/app_usbd_audio.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/cdc/acm/app_usbd_cdc_acm.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/dummy/app_usbd_dummy.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/hid/generic/app_usbd_hid_generic.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/hid/kbd/app_usbd_hid_kbd.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/hid/mouse/app_usbd_hid_mouse.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/hid/app_usbd_hid.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/usbd/class/msc/app_usbd_msc.c)
	    set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/modules/nrfx/drivers/src/nrfx_usbd.c)
    ...
    if(UBINOS__BSP__NRF52_SOFTDEVICE_PRESENT)
        ...
        elseif(UBINOS__BSP__NRF52_SOFTDEVICE_NAME STREQUAL "S140")
            include_directories(${_tmp_source_dir}/nRF5_SDK/components/softdevice/s140/headers)
            include_directories(${_tmp_source_dir}/nRF5_SDK/components/softdevice/s140/headers/nrf52)
        else()
        ...
        elseif(UBINOS__BSP__CPU_MODEL STREQUAL "NRF52840XXAA")
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_aes.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_aes_aead.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_chacha_poly_aead.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_ecc.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_ecdh.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_ecdsa.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_eddsa.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_hash.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_hmac.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_init.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_mutex.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_rng.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/libraries/crypto/backend/cc310/cc310_backend_shared.c)
        else()
		...
		if(NRF5SDK__IOT_ENABLED)
	        ...
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/ble/ble_services/ble_ipsp)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/errno)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ble_6lowpan)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/common)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/context_manager)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_parse)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/medium)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/medium/ble_ncfgs)
	        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/medium/commissioning)
  
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/ble/ble_services/ble_ipsp/ble_ipsp.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/errno/errno.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ble_6lowpan/ble_6lowpan.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/context_manager/iot_context_manager.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_parse/ipv6_parse.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/medium/ble_ncfgs/ble_ncfgs.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/medium/commissioning/commissioning.c)
	        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/medium/ipv6_medium_ble.c)

			if(NRF5SDK__IOT_TIMER_ENABLED)

		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/iot_timer)
		        
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/iot_timer/iot_timer.c)

	        endif()

			if(NRF5SDK__IOT_SOCKET_ENABLED)

		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/socket/common)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/socket/config/medium)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/socket/api)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/fifo)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/mbuf)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/portdb)
	
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/common/sleep.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/common/socket.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/config/medium/config_medium.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/addr_util/inet_pton.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/fifo/nrf_fifo.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/mbuf/mbuf.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/libraries/portdb/portdb.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/platform/ble/socket_ble.c)

	        endif()

			if(NRF5SDK__LWIP_ENABLED)
			
		        include_directories(${_tmp_source_dir}/nRF5_SDK/external/lwip/src/port)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/external/lwip/src/port/arch)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/external/lwip/src/include)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/external/lwip/src/include/netif)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/external/lwip/src/include/lwip)
	
			
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/def.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/dhcp.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/dhcp6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/dns.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv4/icmp.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/icmp6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/inet6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/inet_chksum.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/init.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ip.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv4/ip4.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv4/ip4_addr.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/ip6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/ip6_addr.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/memp.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/mld6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/ipv6/nd6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/netif.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/port/nrf_platform_port.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/pbuf.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/raw.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/sys.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/tcp.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/tcp_in.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/tcp_out.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/timeouts.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/external/lwip/src/core/udp.c)

				if(NRF5SDK__IOT_SOCKET_ENABLED)
			        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/transport/lwip/transport_handler.c)
		        endif()
	
		    else()
	
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/pbuffer)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/udp)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/utils)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/icmp6)
		        include_directories(${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/include)
	
				set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/icmp6/icmp6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/ipv6/ipv6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/pbuffer/iot_pbuffer.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/udp/udp6.c)
		        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/ipv6_stack/utils/ipv6_utils.c)

				if(NRF5SDK__IOT_SOCKET_ENABLED)
			        set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/nRF5_SDK/components/iot/socket/transport/ipv6/transport_handler.c)
		        endif()
